...
\begin{tikzpicture}
    \clip (0,0) circle (2cm);
    \node at (0,0) {\includegraphics[width=4cm]{media/Photo.jpg}};
\end{tikzpicture}
...
Intern \textbf{data platform engineer} at \href{https://ya.ru}{\raisebox{-0.2em}{\includegraphics[height=1em]{media/yandex.png}}~\hspace{-0.40em}\textbf{andex}} Search/Ads ML Infrastructure \textit{(May 2024 -- October 2024)}. Helped to develop platform for building data pipelines based on \href{https://github.com/ytsaurus/ytsaurus}{YTsaurus}. Implemented a new type of tasks (DAG nodes); upgraded AutoDoc -- a library for DAG nodes' dependencies codegen.

\MySkip

Author of \href{https://realkarych.github.io/rxconf/}{\raisebox{-0.35em}{\includegraphics[height=1.4em]{media/rxconf.png}}\textbf{RxConf}}, a library for real-time configuration management in Python with built-in support for common config types.

\MySkip

Founder of \hspace{0.3em}\href{https://github.com/realkarych/postamt/}{\raisebox{-0.3em}{\includegraphics[height=1.3em]{media/postamt_round.png}} \hspace{-0.1em}\textbf{Postamt}}, an experimental email client powered by Telegram forums and WebApps.
